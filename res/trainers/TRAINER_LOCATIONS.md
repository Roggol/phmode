...
Resort Area, Stark Mountain, Turnback Cave, the postgame roaming Cheryl/Riley/
...
- `dawn_jubilife_city_piplup.json` — Lv. 10
...
- `lass_madeline.json` — Lv. 10
- `rival_route_203_chimchar.json` — Lv. 12
- `rival_route_203_piplup.json` — Lv. 12
- `rival_route_203_turtwig.json` — Lv. 12
- `youngster_dallas.json` — Lv. 10
...
- `bug_catcher_jack.json` — Lv. 19
- `bug_catcher_phillip.json` — Lv. 19
- `cheryl_eterna_forest.json` — Lv. 19
- `lass_briana.json` — Lv. 19
- `psychic_elijah.json` — Lv. 19
- `psychic_kody.json` — Lv. 19
...
- `galactic_grunt_mt_coronet_tunnel_room_2.json` — Lv. 27 (Galactic grunt)
- `galactic_grunt_mt_coronet_tunnel_room_3.json` — Lv. 27 (Galactic grunt)

### Mt Coronet 3F
- `galactic_grunt_mt_coronet_3f_1.json` — Lv. 27 (Galactic grunt)
- `galactic_grunt_mt_coronet_3f_2.json` — Lv. 27 (Galactic grunt)

### Mt Coronet 4F Rooms 1 And 2
- `galactic_grunt_mt_coronet_4f_1.json` — Lv. 27 (Galactic grunt)
- `galactic_grunt_mt_coronet_4f_2.json` — Lv. 27 (Galactic grunt)

### Mt Coronet 5F
- `galactic_grunt_mt_coronet_5f_1.json` — Lv. 27 (Galactic grunt)
- `galactic_grunt_mt_coronet_5f_2.json` — Lv. 27 (Galactic grunt)
...
- `galactic_grunt_team_galactic_eterna_building_1f_2.json` — Lv. 27 (Galactic grunt)

### Team Galactic Eterna Building 2F
- `galactic_grunt_team_galactic_eterna_building_2f_1.json` — Lv. 27 (Galactic grunt)
- `galactic_grunt_team_galactic_eterna_building_2f_2.json` — Lv. 27 (Galactic grunt)

### Team Galactic Eterna Building 3F
- `galactic_grunt_team_galactic_eterna_building_3f.json` — Lv. 27 (Galactic grunt)
- `scientist_travon.json` — Lv. 26
...
- `dawn_veilstone_city_piplup.json` — Lv. 33
- `dawn_veilstone_city_turtwig.json` — Lv. 33
- `galactic_grunt_veilstone_city_1.json` — Lv. 34 (Galactic grunt)
- `galactic_grunt_veilstone_city_2.json` — Lv. 34 (Galactic grunt)
- `lucas_veilstone_city_chimchar.json` — Lv. 33
...
- `artist_ismael.json` — Lv. 41
- `beauty_gabriella.json` — Lv. 41
- `beauty_harley.json` — Lv. 41
- `breeder_kaylee.json` — Lv. 41
- `cameraman_darryl.json` — Lv. 41
- `collector_eugene.json` — Lv. 41
- `gentleman_leonardo.json` — Lv. 41
- `lady_kylie.json` — Lv. 41
- `lass_blythe.json` — Lv. 41
- `pi_kendrick.json` — Lv. 41
- `pokefan_meredith.json` — Lv. 41
- `reporter_valerie.json` — Lv. 41
- `rich_boy_roman.json` — Lv. 41
- `school_kid_esteban.json` — Lv. 41
- `scientist_emilio.json` — Lv. 41
- `socialite_rebecca.json` — Lv. 41
- `veteran_emanuel.json` — Lv. 41

### Route 213
- `beauty_cyndy.json` — Lv. 41
- `fisherman_kenneth.json` — Lv. 41
- `sailor_paul.json` — Lv. 41
- `swimmer_evan.json` — Lv. 41
- `swimmer_haley.json` — Lv. 41
- `swimmer_mary.json` — Lv. 41
- `swimmer_sheltin.json` — Lv. 41
...
- `rival_canalave_city_piplup.json` — Lv. 49
- `rival_canalave_city_turtwig.json` — Lv. 49

### Iron Island B1F Left Room
- `camper_lawrence.json` — Lv. 47

### Iron Island B1F Right Room
- `picnicker_summer.json` — Lv. 47

### Iron Island B2F Left Room
- `ace_trainer_brenda.json` — Lv. 47
- `ace_trainer_jonah.json` — Lv. 47
- `battle_girl_tyler.json` — Lv. 47
- `black_belt_kendal.json` — Lv. 47
- `galactic_grunt_iron_island_1.json` — Lv. 48 (Galactic grunt)
- `galactic_grunt_iron_island_2.json` — Lv. 48 (Galactic grunt)
- `hiker_damon.json` — Lv. 47
- `hiker_maurice.json` — Lv. 47
- `riley_iron_island.json` — Lv. 47
- `worker_brendon.json` — Lv. 47
- `worker_quentin.json` — Lv. 47

### Iron Island B2F Right Room
- `worker_braden.json` — Lv. 47
- `worker_noel.json` — Lv. 47

### Route 218
- `fisherman_luc.json` — Lv. 47
- `fisherman_miguel.json` — Lv. 47
...
### Route 210 North
- `ace_trainer_alyssa.json` — Lv. 53
- `ace_trainer_ernest.json` — Lv. 53
- `bird_keeper_brianna.json` — Lv. 53
- `black_belt_adam.json` — Lv. 53
- `double_team_zac_and_jen.json` — Lv. 53
- `dragon_tamer_patrick.json` — Lv. 53
- `ninja_boy_davido.json` — Lv. 53
...
- `ace_trainer_garrett.json` — Lv. 53
- `ace_trainer_laura.json` — Lv. 53
- `ace_trainer_maria.json` — Lv. 53
- `black_belt_philip.json` — Lv. 53
- `skier_andrea.json` — Lv. 53
- `skier_bradley.json` — Lv. 53
- `skier_edward.json` — Lv. 53
- `skier_kaitlyn.json` — Lv. 53

### Route 217
- `ace_trainer_dalton.json` — Lv. 53
- `ace_trainer_olivia.json` — Lv. 53
- `black_belt_luke.json` — Lv. 53
- `ninja_boy_ethan.json` — Lv. 53
- `ninja_boy_matthew.json` — Lv. 53
- `skier_bjorn.json` — Lv. 53
- `skier_lexie.json` — Lv. 53
...
- `scientist_fredrick.json` — Lv. 58

### Galactic HQ 2F
- `galactic_grunt_galactic_hq_2f_1.json` — Lv. 59 (Galactic grunt)
- `galactic_grunt_galactic_hq_2f_2.json` — Lv. 59 (Galactic grunt)
- `galactic_grunt_galactic_hq_2f_3.json` — Lv. 59 (Galactic grunt)
- `scientist_darrius.json` — Lv. 58

### Galactic HQ 3F
- `galactic_grunt_galactic_hq_3f_1.json` — Lv. 59 (Galactic grunt)
- `galactic_grunt_galactic_hq_3f_2.json` — Lv. 59 (Galactic grunt)
- `galactic_grunt_galactic_hq_3f_3.json` — Lv. 59 (Galactic grunt)
- `galactic_grunt_galactic_hq_3f_4.json` — Lv. 59 (Galactic grunt)

### Galactic HQ 4F
- `galactic_boss_cyrus_galactic_hq.json` — Lv. 60 (Galactic boss)

### Galactic HQ B2F
- `galactic_grunt_galactic_hq_b2f_1.json` — Lv. 59 (Galactic grunt)
- `galactic_grunt_galactic_hq_b2f_2.json` — Lv. 59 (Galactic grunt)
...
- `galactic_grunt_spear_pillar_1.json` — Lv. 59 (Galactic grunt)
- `galactic_grunt_spear_pillar_2.json` — Lv. 59 (Galactic grunt)
- `rival_spear_pillar_chimchar.json` — Lv. 60
- `rival_spear_pillar_piplup.json` — Lv. 60
- `rival_spear_pillar_turtwig.json` — Lv. 60
...
- `bird_keeper_hana.json` — Lv. 63
- `black_belt_miles.json` — Lv. 63
- `dragon_tamer_clinton.json` — Lv. 63
- `psychic_bryce.json` — Lv. 63
- `veteran_edgar.json` — Lv. 63

### Victory Road 1F Room 2
- `ace_trainer_arthur.json` — Lv. 63
- `ace_trainer_brandi.json` — Lv. 63
- `ace_trainer_clarice.json` — Lv. 63
- `ace_trainer_micah.json` — Lv. 63
- `bird_keeper_autumn.json` — Lv. 63
- `black_belt_eddie.json` — Lv. 63
- `black_belt_willie.json` — Lv. 63
- `dragon_tamer_joe.json` — Lv. 63
- `marley_victory_road.json` — Lv. 63
- `psychic_deandre.json` — Lv. 63
- `psychic_desiree.json` — Lv. 63
- `psychic_kendra.json` — Lv. 63
- `psychic_landon.json` — Lv. 63
- `veteran_brenden.json` — Lv. 63
- `veteran_terrell.json` — Lv. 63

### Victory Road 2F
- `ace_trainer_omar.json` — Lv. 63
- `ace_trainer_sydney.json` — Lv. 63
- `double_team_al_and_kay.json` — Lv. 63
- `veteran_clayton.json` — Lv. 63

### Victory Road B1F
- `ace_trainer_henry.json` — Lv. 63
...
- `youngster_darius.json` — Lv. 13
- `youngster_jonathon.json` — Lv. 13

### Eterna Gym (Gardenia) — active cap 23
- `aroma_lady_angela.json` — Lv. 22
- `aroma_lady_jenna.json` — Lv. 22
- `beauty_lindsay.json` — Lv. 22
- `lass_caroline.json` — Lv. 22

### Hearthome Gym (Fantina) — active cap 30
- `ace_trainer_allen.json` — Lv. 29
- `ace_trainer_catherine.json` — Lv. 29
- `camper_drew.json` — Lv. 29
- `lass_molly.json` — Lv. 29
- `picnicker_cheyenne.json` — Lv. 29
- `school_kid_chance.json` — Lv. 29
- `school_kid_mackenzie.json` — Lv. 29
- `youngster_donny.json` — Lv. 29

### Veilstone Gym (Maylene) — active cap 37
- `black_belt_colby.json` — Lv. 36
- `black_belt_darren.json` — Lv. 36
- `black_belt_jeffery.json` — Lv. 36
- `black_belt_rafael.json` — Lv. 36

### Pastoria Gym (Wake) — active cap 45
- `fisherman_erick.json` — Lv. 44
- `fisherman_walter.json` — Lv. 44
- `sailor_damian.json` — Lv. 44
- `sailor_samson.json` — Lv. 44
- `tuber_caitlyn.json` — Lv. 44
- `tuber_jacky.json` — Lv. 44

### Canalave Gym (Byron) — active cap 51
- `ace_trainer_breanna.json` — Lv. 50
- `ace_trainer_cesar.json` — Lv. 50
- `black_belt_david.json` — Lv. 50
- `black_belt_ricky.json` — Lv. 50
- `worker_gary.json` — Lv. 50
- `worker_gerardo.json` — Lv. 50
- `worker_jackson.json` — Lv. 50

### Snowpoint Gym (Candice) — active cap 57
- `ace_trainer_alicia.json` — Lv. 56
- `ace_trainer_anton.json` — Lv. 56
- `ace_trainer_brenna.json` — Lv. 56
- `ace_trainer_isaiah.json` — Lv. 56
- `ace_trainer_savannah.json` — Lv. 56
- `ace_trainer_sergio.json` — Lv. 56

### Sunyshore Gym (Volkner) — active cap 62
- `ace_trainer_destiny.json` — Lv. 61
- `ace_trainer_zachery.json` — Lv. 61
- `guitarist_jerry.json` — Lv. 61
- `guitarist_lonnie.json` — Lv. 61
- `guitarist_preston.json` — Lv. 61
- `poke_kid_meghan.json` — Lv. 61
- `school_kid_forrest.json` — Lv. 61
- `school_kid_tiera.json` — Lv. 61
