...
#define NUM_MAIL_TYPES  (LAST_MAIL_IDX - FIRST_MAIL_IDX + 1)
...
#define ITEM_USE_FUNC_PPHM         25
#define ITEM_USE_FUNC_REPEL_TOGGLE 26
#define ITEM_USE_FUNC_POKETCH_MANIPULATOR 27
